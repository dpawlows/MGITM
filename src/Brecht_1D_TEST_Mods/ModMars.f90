...
!  LTE-NLTE RATIO MODIFIED FOR MTGCM CALIBRATION:  12/19/11  S. W. Bougher
!  -- L_NLTE = 51 revised tables: XLTEPRESSURE, XLTEFACTOR  (LV-1998)
!  Dust opacity and CR time evolving arrays setup: 11/22/11 D. Pawlwoski

!  LTE-NLTE RATIO MODIFIED FOR MTGCM CALIBRATION:  11/11/11  S. W. Bougher
!  LTE-NLTE RATIO MODIFIED FOR MTGCM CALIBRATION:  12/20/11  S. W. Bougher
!  -- L_NLTE = 37 for revised tables: XLTEPRESSURE, XLTEFACTOR
!  Dust opacity and CR time evolving arrays setup: 11/22/11 D. Pawlwoski
