...
!  Fix applied to intialization of LowAtmosRadRate:  commented out
!  -- S. Nelli recommended this for proper running of radcode
...
!     write(*,*) '==========> Now Exiting Neutral Friction Calculation!!'
  ...
  RadCooling = 0.0
  !  Should this be commented out for proper calculation of LTE RT code?
