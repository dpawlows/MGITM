! ---------------------------------------------------------------------
!! output_common,ORIG.f90
!  --revision:  11-10-26:  S. W. Bougher
!  --           1duser added for thermal balances
!! output_common.QION_ORIG.f90
!  --revision:  12-12-29:  S. W. Bougher
!  --           Above 1duser mods retained
!  --           QION mods from Dave pawlwoski added
!  --           7-places modified
! ---------------------------------------------------------------------
...
subroutine output(dir, iBlock, iOutputType)
  ...
  ! -- 12-12-29 Update from Dave Pawlwoski
  !-----------

! New from Dave Pawlwoski
! if ( IsFirstTime         .or. &
...
! -------------------------------------------------------------------------------------------
! Updated code from Dave Pawlwoski added: 12-12-29
...
! Updated with QION from Dave Pawlwoski for Laila Andersson tables
! December 29, 2012
     ...
     do iLat=-1,nLats+2
        ...
        do iLon=-1,nLons+2
           ...
           write(iOutputUnit_)       &
                ...
                write(*,*) sza(iilon,iilat,iblock)*180/Pi
        enddo
     enddo
  enddo
