...
subroutine advance_vertical_1d
  ...
  implicit none
  !-----------------------------------------------------------
  !  verical velcity damping (on/off) for testing
  !  *  straight VertTau calculation (on)
  !  *  bigval used for VertTau calculation (off)
  !-----------------------------------------------------------
...
! real :: NewSumRho, NewLogSumRho, rat, ed
  real :: NewSumRho, NewLogSumRho, rat, ed, bigval
