...
!  Modify EGWD contribution to Momentum equation  (zonal amd merid)
!  S. W. Bougher: 18-05-24  Initial changes for EGWD2
!  S. W. Bougher: 18-06-05  Velocity term addition of GWDrag updated
!  S. W. Bougher: 18-06-25  Outputs for EGWD2 terms added
...
!        enddo
     ...
     !! To turn off GWDrag, turn UseGravityWave=.false. in UAM.in

!    Velocity(1:nLons, 1:nLats, 1:nAlts, :, iBlock) = &
!         Velocity(1:nLons, 1:nLats, 1:nAlts, :, iBlock) + Dt * ( &
!         IonDrag) + Viscosity + GWDrag(1:nLons,1:nLats,1:nAlts,:,iBlock)
     Velocity(1:nLons, 1:nLats, 1:nAlts, :, iBlock) = &
          Velocity(1:nLons, 1:nLats, 1:nAlts, :, iBlock) + Dt * ( &
